# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-15 20:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internship_flag', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('give_back', models.CharField(choices=[('Money', 'Money (donations to department, scholarship funds, etc.)'), ('Time', 'Time (mentorship, guest lectures, etc.)'), ('Both', 'Both'), ('No', "I don't plan on giving back")], max_length=30)),
                ('my_choice', models.BooleanField(choices=[('Y', 'Yes'), ('N', 'No')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.CharField(choices=[('Y', 'Yes'), ('N', 'No'), ('M', 'Maybe')], max_length=1)),
                ('time_looking', models.IntegerField(blank=True, choices=[('0-10', '0 - 10 Hours'), ('10-20', '10 - 20 Hours'), ('20-30', '20 - 30 Hours'), ('40-60', '40 - 60 Hours'), ('60+', '60+ Hours')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('program_introduction', models.CharField(choices=[('1', 'Student in the program'), ('2', 'Family member'), ('3', 'Alumni'), ('4', 'School counselor'), ('5', 'Online'), ('6', 'Advertisement'), ('7', 'Information Session'), ('8', 'IS 201'), ('9', 'Other')], max_length=30)),
                ('mism_decision', models.CharField(max_length=130)),
                ('again', models.CharField(choices=[('Y', 'Yes'), ('N', 'No'), ('NS', 'Not Sure')], max_length=2)),
